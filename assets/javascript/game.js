$(document).ready(function () {
	...
	function startGame() {
		...
		lukeSkywalker = {
			...
			attackPower: 8,
			counterAttack: 5,
			img:"assets/images/lukeskywalker.jpeg"
		}
		...
		characterSelection = [obiWanKenobi,lukeSkywalker,countDooku,darthVader];
	...
	$("#attack").on("click", function() {
		...
		if(character !== null && character.healthPoints > 0 && defenders.length > 0) {
			...
			if(defender !== null) {
				...
				character.healthPoints -= defender.counterAttack;
				status += defender.name + " attacked you back for " + defender.counterAttack + " damage.<br>";
